...
alldata <- read.delim("demo_independent.txt", header=TRUE) #Define the name of the tab delimited txt file in the working directory that contains 2 columns: an independent (grouping) variable and a dependent variable.
