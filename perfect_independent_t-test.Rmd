...
setwd("C:\\Users\\Daniel\\Dropbox\\ConfidenceIntervals")   # set working directory (i.e., the location of your data file).
alldata <- read.delim("independent2.txt", header=TRUE) #Define the name of the tab delimited txt file in the working directory that contains 3 columns: a subject identifier and 2 columns of the data in the two within-subject conditions.
...
xlabel<-"1" #name group 1 - needs to match the datafile!
ylabel<-"0" #name group 2 - needs to match the datafile!
...
BESTHDI<-hdi(BESTdiff, credMass = 0.95)
mean(BESTdiff)
